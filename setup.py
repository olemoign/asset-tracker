...
parsys_utilities_4_1_3 = f'{tracker}/ae4f204e501446610aadf210445ced292e270e9942a8a88bd552ae53a3a2b714/parsys_utilities-4.1.3-py3-none-any.whl'  # noqa: E501
requires = [
    'alembic==1.7.5',
    'arrow==1.2.1',
    'celery[redis]==5.2.3',
    'filedepot==0.8.0',
    'jinja2==3.0.3',
    f'parsys-utilities @ {parsys_utilities_4_1_3}',
    'paste==3.5.0',
