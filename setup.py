...
parsys_utilities_4_1_5 = f'{tracker}/1ff08c61624c2332ea19c0a728c32aae17b8b6576f47d1f9b088340c840219ad/parsys_utilities-4.1.5-py3-none-any.whl'  # noqa: E501
requires = [
    'alembic==1.7.5',
    'arrow==1.2.1',
    'celery[redis]==5.2.3',
    'filedepot==0.8.0',
    'jinja2==3.0.3',
    f'parsys-utilities @ {parsys_utilities_4_1_5}',
    'paste==3.5.0',
