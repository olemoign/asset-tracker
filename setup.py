...
parsys_utilities_4_2_2 = f'{tracker}/a85738177dda9ad7006266e2f753330c73b88833933e0dc746de821b3cf0344d/parsys_utilities-4.2.2-py3-none-any.whl'  # noqa: E501
requires = [
    'alembic==1.7.5',
    'arrow==1.2.2',
    'celery[redis]==5.2.3',
    'filedepot==0.8.0',
    'jinja2==3.0.3',
    f'parsys-utilities @ {parsys_utilities_4_2_2}',
    'paste==3.5.0',
