...
parsys_utilities_3_6_2 = f'{tracker}/db69234469868ab5751b508158ce5591b155ff2506f66e02847d411e4bd0246f/parsys_utilities-3.6.2-py3-none-any.whl'  # noqa: E501
requires = [
    'alembic==1.6.5',
    'arrow==1.1.0',
    'celery[redis]==5.1.0',
    ...
    'jinja2==3.0.1',
    f'parsys-utilities @ {parsys_utilities_3_6_2}',
    'paste==3.5.0',
