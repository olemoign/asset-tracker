...
parsys_utilities_3_6_1 = f'{tracker}/c7b8b1b4d646293d6a82410ea41bf29cc12b73b72e9262e0cf0c893605e73781/parsys_utilities-3.6.1-py3-none-any.whl'  # noqa: E501
requires = [
    'alembic==1.6.3',
    'arrow==1.1.0',
    'celery[redis]==5.1.0',
    ...
    'jinja2==3.0.1',
    f'parsys-utilities @ {parsys_utilities_3_6_1}',
    'paste==3.5.0',
