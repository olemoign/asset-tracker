...
parsys_utilities_4_2_1 = f'{tracker}/76e4be423ba8192182c40e0542020fe43a756620a2f88d943e9ee81b8ca1fe42/parsys_utilities-4.2.1-py3-none-any.whl'  # noqa: E501
requires = [
    'alembic==1.7.5',
    'arrow==1.2.1',
    'celery[redis]==5.2.3',
    'filedepot==0.8.0',
    'jinja2==3.0.3',
    f'parsys-utilities @ {parsys_utilities_4_2_1}',
    'paste==3.5.0',
