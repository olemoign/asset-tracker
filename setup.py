...
parsys_utilities_4_2_4 = f'{tracker}/3ce39810019234fab2cf02e1a23a41dec729bea160928830c4fbf8167627fb14/parsys_utilities-4.2.4-py3-none-any.whl'  # noqa: E501
requires = [
    'alembic==1.7.6',
    'arrow==1.2.2',
    'celery[redis]==5.2.3',
    'filedepot==0.8.0',
    'jinja2==3.0.3',
    f'parsys-utilities @ {parsys_utilities_4_2_4}',
    'paste==3.5.0',
