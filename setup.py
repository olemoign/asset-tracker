...
parsys_utilities_4_2_3 = f'{tracker}/de8d6a5c2a108b3a967615a554c255193b2690bee8674ffb81eb1bf64fbf2546/parsys_utilities-4.2.3-py3-none-any.whl'  # noqa: E501
requires = [
    'alembic==1.7.6',
    'arrow==1.2.2',
    'celery[redis]==5.2.3',
    'filedepot==0.8.0',
    'jinja2==3.0.3',
    f'parsys-utilities @ {parsys_utilities_4_2_3}',
    'paste==3.5.0',
