...
parsys_utilities_3_7_2 = f'{tracker}/36c32c309c697bc4f998e8f344fadac4748b2bf988d699a812cadb7664c5b6a3/parsys_utilities-3.7.2-py3-none-any.whl'  # noqa: E501
requires = [
    'alembic==1.7.4',
    'arrow==1.2.0',
    'celery[redis]==5.1.2',
    'filedepot==0.8.0',
    'jinja2==3.0.2',
    f'parsys-utilities @ {parsys_utilities_3_7_2}',
    'paste==3.5.0',
