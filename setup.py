...
parsys_utilities_4_1_2 = f'{tracker}/6e89ff6eccd287fba31079792db5bca75f86efe503581e8cbc7aaccb929569e0/parsys_utilities-4.1.2-py3-none-any.whl'  # noqa: E501
requires = [
    'alembic==1.7.5',
    'arrow==1.2.1',
    'celery[redis]==5.2.1',
    'filedepot==0.8.0',
    'jinja2==3.0.3',
    f'parsys-utilities @ {parsys_utilities_4_1_2}',
    'paste==3.5.0',
