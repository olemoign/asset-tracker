...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['family_id'], ['equipment_family.id'], name=op.f('fk_equipment_family_id_equipment_family')),
    ...
    sa.Column('status', sa.Enum('service', 'repair', 'calibration', 'transit_parsys', 'transit_customer', name='status'), nullable=True),
